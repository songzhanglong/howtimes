...
- (void)xwp_updateDataSource{
    ...
    GrowTemplateModel *item = temp[_originalIndexPath.section];
    NSMutableArray *orignalSection = item.template;
    if (_moveIndexPath.section == _originalIndexPath.section) {
        ...
        GrowTemplateModel *moveItem = temp[_moveIndexPath.section];
        NSMutableArray *currentSection = moveItem.template;
